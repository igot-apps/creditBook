...
import { Phone, MessageSquare, MessageCircle, Edit3, Archive, Truck, CreditCard, Ban, Clock, AlertTriangle, RotateCcw } from "lucide-react";
import useStore from "../store/useStore";
import { formatCurrency, formatDate } from "../utils/helpers";
import { openSMS, openWhatsApp, openDialer } from "../utils/communication";
import { SupplierService } from "../services/SupplierService";
import { TopBar } from "../components/TopBar";
import { SupplierTransactionDetails } from "../components/supplier/SupplierTransactionDetails";
...
export const SupplierProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pb-24">
      ...
      {/* Transaction Details Modal - Using separate component */}
      {viewingTransaction && (
